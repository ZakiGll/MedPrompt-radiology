...
def main():
    ...
    if OPENAI_API_KEY := st.text_input("GOOGLE API KEY:"):
        ...
        def generate_conclusion(observation):
            ...
            prompt = f"""
                ...
                You are a radiology assistant, your role is to provide a Conclusion of the radiology report indicating the medical problem that the patient has.(You must only give the conclusion! do not rewrite the observation section! and make sure to give the result in french!)
        

                * Here is the Radiology observation (text describing the case):\n {observation} \n
                * Some Similar reports retrieved using RAG: \n {docs}
